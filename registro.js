//codigo para tomar los datos del formulario
...
formsignin.addEventListener('submit', (e) => {
    ...
    alert('Su usuario ha sido guardado correctamente. ¡Bienvenido!')
...
const requirements = [
    ...
    { regex: /[^A-Za-z0-9]/, index: 3 }, //minimo 1 caractere especial
